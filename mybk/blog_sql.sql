...
insert  into `food`(`LIST`,`id`,`oneId`,`twoId`,`article_name`,`editer`,`content`,`TIME`,`visitors`,`daodu`,`imgsrc`,`recommend`,`art_show`) values (1,'OGM1Y2I1N2ItNTRiNi00NDRiLThjNzMtMzg1MGRiNzUzYmM3','OTAyZThmYTctY2M1MC00MTJlLWEzY2MtYzY4NjJiZmIyNzQ0','Mjk3OGQxNDgtZjNkNS00NWJmLTk4MjctNzgxOGUyMzBkY2E1','土豆丝','李四','<p>法大师傅撒法</p>','2017-09-07 08:54:50',0,'似的发射点','undefined',1,1);
...
insert  into `one_class`(`id`,`enname`,`cnname`,`time`) values ('MTgwNjFlMzQtNThhYi00MGVlLWJhYjctZjQzNDQzZWU0YTYw','tec','技术','2017-09-07 08:52:59'),('OTAyZThmYTctY2M1MC00MTJlLWEzY2MtYzY4NjJiZmIyNzQ0','food','美食','2017-09-07 08:53:36');
...
insert  into `tec`(`LIST`,`id`,`oneId`,`twoId`,`article_name`,`editer`,`content`,`TIME`,`visitors`,`daodu`,`imgsrc`,`recommend`,`art_show`) values (1,'YjAzMGIxMTktN2EyYS00YjYzLWI5NzMtMDU0MWJjYmQ1OTY3','MTgwNjFlMzQtNThhYi00MGVlLWJhYjctZjQzNDQzZWU0YTYw','YTZkMmYwZjgtZTI0YS00YTA4LWIzOTktNWQ0ZmJiMmJmMDMz','教学大纲','张三','<p>士大夫撒旦发射点发</p>','2017-09-07 08:54:19',0,'似的发射点','undefined',1,1);
...
insert  into `two_class`(`id`,`parent_id`,`enname`,`cnname`,`article_num`,`time`) values ('Mjk3OGQxNDgtZjNkNS00NWJmLTk4MjctNzgxOGUyMzBkY2E1','OTAyZThmYTctY2M1MC00MTJlLWEzY2MtYzY4NjJiZmIyNzQ0','chuan','川菜',0,'2017-09-07 08:53:36'),('YTZkMmYwZjgtZTI0YS00YTA4LWIzOTktNWQ0ZmJiMmJmMDMz','MTgwNjFlMzQtNThhYi00MGVlLWJhYjctZjQzNDQzZWU0YTYw','vue','vue',0,'2017-09-07 08:52:59'),('YzQ2YjVlZjMtNTA3MS00NzBmLWI4OTQtMjM5ZDNhYmY4ZTY2','MTZmNGFlYWYtMmQyMC00Mzc0LWI2NDYtNDZmYjA5M2Q4Mjlj','sfd','fds',0,'2017-09-05 08:59:03');
